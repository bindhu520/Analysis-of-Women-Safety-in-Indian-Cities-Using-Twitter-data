...
main = tkinter.Tk()
main.title("Analysis of Women Safety in Indian Cities Using Twitter data") #designing main screen
...
def upload(): #function to upload twitter profile
    global filename
...
pathlabel.config(bg='purple', fg='white')
